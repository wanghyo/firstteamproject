...
<script type="text/javascript">
	$(function() {
		...
		$("#fa-solid").click(function() {
			var likeNumValue = $(this).attr("data-num");

			$.ajax({
				url : "/supporter/likeDelete",
				type : "post",
				/* data:$("#like_data").serialize(), */
				data : {
							...
							<c:forEach var="like" items="${likeAllList}" varStatus="status">
								<div class="soollike_list" id="soollike_list" 	data-num="${like.likeNum}">
									<script type="text/javascript">
										$(document).ready(
												function() {
													var likeNumValue = $('.soollike_list').attr('data-num');
													console.log(likeNumValue);
												});
									</script>
									...
									<div class="soollike_ddd">
										<ul class="soollike_ul">
											<li class="soolproject_title">
												...
												<span class="project_title"> ${like.project.title}/ ${like.likeNum} </span>
												</li>
											<li class="price">
										...
										<ul class="tage_ul">
											<li class="tage" id="projectDesc">${like.project.projectDesc}</i></li>
										</ul>
