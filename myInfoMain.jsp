	...
	<div id="wrap">
		...
		<div class="wrap_center wrap_myinfo">
				...
				<div class="maker_form">
					...
					<ul class="maker_ul">
						...
						<li class="maker_li2 li_style" id="maker_li2"><a
							href="/project/projectList">판매현황</a></li>
					</ul>
				</div>
			...
			<section class="main_section">
				<div class="etc_info">
					<span class="point_info"> <a href="/member/pwConfirm"> <i
							class="fa-brands fa-product-hunt"> 포인트</i> <span class="point_p">
								${pointSum.pointSum} P</span>
					</a>
					</span> <span class="maker_info"> <span
						class="funding_info maker_info_span"> <a
							href="/supporter/orderList" class="maker_info_a"> <span
								class="maker_info_span1">펀딩 오더</span> <span
								class="maker_info_span2">0</span>
						</a>
					</span> <span class="pro_info maker_info_span"> <a
							href="/project/projectList" class="maker_info_a"> <span
								class="maker_info_span1">내 프로젝트</span> <span
								class="maker_info_span2">0</span>
						</a>
					</span>
					</span>
									...
									<c:if test="${status.index < 6}">
										...
										<div class="slider">
											...
											<div class="slider_div">
												<a
													href="/project/fundingDetailView?projectNum=${like.project.projectNum}">
